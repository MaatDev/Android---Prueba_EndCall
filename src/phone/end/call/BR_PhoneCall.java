...
public class BR_PhoneCall extends BroadcastReceiver{
	...
	public void onReceive(Context context, Intent intent) {
		...
		//Sacar en bundle que trae del intent recibido
		 ...
		 SharedPreferences sPref = context.getSharedPreferences(Prueba_EndCallActivity.TAG
				 , Context.MODE_PRIVATE);
		 
		 //Comparar el número de la llamada con el número guardado
		 
		 if(PhoneNumberUtils.compare(sPref.getString(Prueba_EndCallActivity.numberKey,
				 ""), this.number)){
